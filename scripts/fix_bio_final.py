...
# Find end of TimelineItem
end_idx = -1
for i in range(start_idx, len(lines)):
    if lines[i].startswith('function PublicLinksView('):
        end_idx = i
        break
...
"""
    ...
    print("Successfully updated Bio and Timeline components")
else:
