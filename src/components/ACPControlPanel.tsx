        ...
        <div className="relative bg-neutral-900/50 border border-white/5 backdrop-blur-3xl p-8 rounded-[2rem] shadow-2xl max-w-sm w-full">
          <div className="text-center mb-6">
            ...
            <p className="text-neutral-500 text-xs mt-1 leading-relaxed">
              Trang quản trị cấp cao dành cho Chủ sở hữu hệ thống Chorus.vn
            </p>
          </div>

          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-xs text-neutral-400 font-bold mb-1.5 uppercase tracking-wider">ID Đăng nhập</label>
              <input 
                type="text" 
                required
                value={username}
            ...
            <div>
              <label className="block text-xs text-neutral-400 font-bold mb-1.5 uppercase tracking-wider">Mật khẩu</label>
              <input 
                type="password" 
                required
                value={password}
            ...
            >
              {isLoading ? 'Đang xác minh...' : 'Đăng nhập ACP'}
            </button>
          </form>
        </div>
      </div>
